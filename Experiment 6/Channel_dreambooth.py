# -*- coding: utf-8 -*-
"""Channel_Specific.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1U5inAZhnFfFMaZ_bAqu1spzgASTw8clv
"""
...
# @title reshape / preprocess all photos
import os
from PIL import Image
...
images = read_images('/content/drive/MyDrive/236/mrbeast_train', size)
...
instance_prompt = "\u003Cjimmy-donaldson> man" #@param {type:"string"}
...
prior_preservation_class_prompt = "A photo of a man named Jimmy Donaldson " #@param {type:"string"}

num_class_images = 30
sample_batch_size = 2
prior_loss_weight = 0.5
prior_preservation_class_folder = "/content/drive/MyDrive/236/Men"
class_data_root=prior_preservation_class_folder
class_prompt=prior_preservation_class_prompt

num_class_images = 10 #@param {type: "number"}
sample_batch_size = 2
#@markdown `prior_preservation_weight` determins how strong the class for prior preservation should be
prior_loss_weight = 0.2 #@param {type: "number"}
...
prior_preservation_class_folder = "/content/drive/MyDrive/236/Men" #@param {type:"string"}
class_data_root=prior_preservation_class_folder
...
class PromptDataset(Dataset):
    def __init__(self, prompts_csv, data_root, num_samples):
        ...
        self.caption_dict = pd.read_csv(prompts_csv).set_index('Id').to_dict()['OpenAICaption']
    ...
    def __getitem__(self, index):
        ...
        prompt =  "Youtube thumbnail with Description" + self.caption_dict.get(image_id, "OpenAICaption")
...
prompts_csv = "/content/drive/MyDrive/236/train_mrbeast_openai.csv"
data_root = save_path
...
output_dir = "/content/drive/MyDrive/236_MrBeastChannel"
...
save_path = '/content/drive/MyDrive/236/MrBeastChannelCapFinal'

# Copying the image to Google Drive
shutil.copytree(image_path, save_path)

# Inference Example Below
# prompt = "\u003CJimmy-Donaldson> in a classroom with other students, looking puzzled, moment of surprise or confusion." #@param {type:"string"}
